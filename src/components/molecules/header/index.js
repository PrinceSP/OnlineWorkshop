...
const Header = ({name,navigation,action,btn,edit,nav,color="#000",bgColor="#fff"})=>{
  ...
  return(
    ...
    backgroundColor:bgColor}}>
      {btn=="customer" ? <Burger stroke={color} strokeWidth="4" strokeLinecap="round" onPress={()=>navigation.getParent("customerDrawer").openDrawer()}/> :
      <Burger stroke={color} strokeWidth="4" strokeLinecap="round" onPress={()=>navigation.getParent("root").openDrawer()}/>}
